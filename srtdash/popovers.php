                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="popovers.php">Popover</a></li>
                    ...
                    <div class="col-lg-6 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php btnPopover("btn btn-lg btn-success mb-3 mr-1","Popover on top","top"); ?>
                                <?php btnPopover("btn btn-lg btn-info mb-3 mr-1","Popover on top","bottom"); ?>
                                <?php btnPopover("btn btn-lg btn-warning mb-3 mr-1","Popover on top","right"); ?>
                                <?php btnPopover("btn btn-lg btn-dark mb-3 mr-1","Popover on top","left"); ?>
                            </div>
                        </div>
                    </div>
                </div>
