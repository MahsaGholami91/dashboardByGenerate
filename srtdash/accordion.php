                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="accordion.php">Accordion</a></li>
                    ...
                    <div class="col-lg-6 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                foreach ($accordionData as $accordionItem) {
                                    accordion($accordionItem['title'], $accordionItem['parentId'], $accordionItem['childId'], $accordionItem['text'],"card-link collapsed");
                                }
