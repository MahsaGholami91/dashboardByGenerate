                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php   
                                    ...
                                    $data = [
                                        ['id' => 1, 'name' => 'Jafar', 'date' => '09 / 07 / 2018', 'price' => ['salary'=>'120$','deposit'=>'400$']],
                                        ['id' => 2, 'name' => 'Ali', 'date' => '09 / 07 / 2018', 'price' => ['salary'=>'120$','deposit'=>'400$']],
                                        ['id' => 3, 'name' => 'Test', 'date' => '09 / 07 / 2018', 'price' => ['salary'=>'120$','deposit'=>'400$']],
                                        ['id' => 4, 'name' => 'Jone', 'date' => '09 / 07 / 2018', 'price' => ['salary'=>'120$','deposit'=>'400$']]
                                    ];
                                    
                                    // basicTable($headers, $data,"text-uppercase bg-dark","table-dark");
                                    dataTables($headers, $data);
                                ?>
                            </div>
                        </div>
                    </div>
